import { LayoutDashboard, ArrowLeftRight, Target, PiggyBank, Bot, BarChart3, RefreshCw, CreditCard } from "lucide-react";
...
const navItems: SubNavItem[] = [
  ...
  { path: "/finance/cards", label: "Cards", icon: CreditCard },
